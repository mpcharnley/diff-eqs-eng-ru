...
\item Use the determinant to make statements about invertibility or rank of a matrix, and linear independence of the columns of that matrix. 
}
...
\end{exercise}
\exsol{%
Rank is 3. Therefore $A$ is invertible, and there is exactly one solution to $A \vec{x} = \begin{bmatrix} 1 \\ 1 \\ 1\end{bmatrix}$, namely $A^{-1}\begin{bmatrix}1 \\ 1 \\ 1 \end{bmatrix}$.
}
