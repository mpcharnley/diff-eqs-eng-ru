...
\end{exercise}
\exsol{%
$\lambda_1 = 3$, $\vec{v}_1 = \left[\begin{smallmatrix} 6\\ 3\\ -1 \end{smallmatrix}\right]$, $\lambda_2 = 2+3i$, $\vec{v}_2 = \left[\begin{smallmatrix} 2 \\ 1-i \\ 0 \end{smallmatrix}\right]$, $\lambda_3 = 2-3i$, $\vec{v}_3 = \left[\begin{smallmatrix} 2 \\ 1+i \\ 0 \end{smallmatrix}\right]$  
}
...
\end{exercise}
\exsol{%
$\lambda_1 = -1$, $\vec{v}_1 = \left[\begin{smallmatrix} 0 \\ 1 \\ 0 \end{smallmatrix}\right]$, $\lambda_2 = 2$, $\vec{v}_2 = \left[\begin{smallmatrix} -7 \\ -\frac{53}{3} \\ 3 \end{smallmatrix}\right]$, $\lambda_3 = 3$, $\vec{v}_3 = \left[\begin{smallmatrix} 2 \\ 4 \\ -1 \end{smallmatrix}\right]$  
}
