...
\emph{\myindex{sink}} or an \emph{\myindex{asymptotically stable node}}.
...
\end{exercise}
\exsol{%
$\displaystyle \vec{x}(t) = C_1 \left[\begin{smallmatrix} 1 \\ 1 \end{smallmatrix}\right]e^{-t} + C_2 \left[\begin{smallmatrix} -1 \\ 3 \end{smallmatrix}\right] e^{-5t}$ \hfill
\raisebox{-0.5\height}{\includegraphics[height=1.5in]{Images/PhasePortraitY1a-213-4.png}}\hfill\hfill
}%
...
\end{exercise}
\exsol{%
$\displaystyle \vec{x}(t) = C_1 \left[\begin{smallmatrix} 3 \\ 1 \end{smallmatrix}\right]e^{5t} + C_2 \left[\begin{smallmatrix} -1 \\ 1 \end{smallmatrix}\right] e^{-3t}$ \hfill
\raisebox{-0.5\height}{\includegraphics[height=1.5in]{Images/PhasePortraitY1a362-1.png}}\hfill\hfill
}%
...
\end{exercise}
\exsol{%
$\displaystyle \vec{x}(t) = C_1 \left[\begin{smallmatrix} 1 \\ 1 \end{smallmatrix}\right]e^{4t} + C_2 \left[\begin{smallmatrix} 2 \\ 5 \end{smallmatrix}\right] e^{t}$ \hfill
\raisebox{-0.5\height}{\includegraphics[height=1.5in]{Images/PhasePortraitY1a6-25-1.png}}\hfill\hfill
}%
