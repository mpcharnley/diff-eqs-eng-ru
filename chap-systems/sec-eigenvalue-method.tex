...
That is exactly what we see in \figurevref{pln:source-fullfig}; the solutions leave the origin along the $\left[\begin{smallmatrix} 1 \\ 0 \end{smallmatrix}\right]$ line and then head to infinity along the $\left[\begin{smallmatrix} 1 \\ 1 \end{smallmatrix}\right]$ line. 
