...
\end{equation*}
\end{exercise}
%\exsol{% eigenvalue 3 \pm 2i, vector [-1-2i, 5]
...
\end{equation*}
\end{exercise}
%\exsol{% eigenvalue -1 \pm 2i, vector [2, -1+i]
%$\displaystyle \vec{x}(t) = C_1 \begin{bmatrix} -4 \\ 3 \end{bmatrix}e^{-4t} + C_2 \begin{bmatrix} 1 \\ -1 \end{bmatrix} e^{-t}$
%}%
...
\end{equation*}
\end{exercise}
%\exsol{% eigenvalue 2 \pm 3i, 2 vector [3 + 2i, -13, -2 + 3i], [0 1 0]
%$\displaystyle \vec{x}(t) = C_1 \begin{bmatrix} -4 \\ 3 \end{bmatrix}e^{-4t} + C_2 \begin{bmatrix} 1 \\ -1 \end{bmatrix} e^{-t}$
%}%
...
\end{equation*}
\end{exercise}
%\exsol{% eigenvalue -3 \pm i, -2 vector [14-2i, -25, -21 + 3i], [-1, 2, 2]
%$\displaystyle \vec{x}(t) = C_1 \begin{bmatrix} -4 \\ 3 \end{bmatrix}e^{-4t} + C_2 \begin{bmatrix} 1 \\ -1 \end{bmatrix} e^{-t}$
%}%
...
\end{exercise}
%\exsol{% eigenvalue -2 \pm 2i, vector [4, -3-i]
%$\displaystyle \vec{x}(t) = C_1 \begin{bmatrix} -4 \\ 3 \end{bmatrix}e^{-4t} + C_2 \begin{bmatrix} 1 \\ -1 \end{bmatrix} e^{-t}$
%}%
...
\end{exercise}
%\exsol{% eigenvalue -1 \pm 2i, -1 vector [10, 4 - 2i, 1 - 3i], [1 0 0]
%$\displaystyle \vec{x}(t) = C_1 \begin{bmatrix} -4 \\ 3 \end{bmatrix}e^{-4t} + C_2 \begin{bmatrix} 1 \\ -1 \end{bmatrix} e^{-t}$
%}%
