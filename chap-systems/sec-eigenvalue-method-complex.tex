...
\LO{
\item Use Euler's formula to find a real-valued general solution to a first order system with complex eigenvalues,
\item Sketch phase portraits for linear first order systems with complex eigenvalues, and
...
\begin{equation*}
\vec{x}(t) = 2\begin{bmatrix} e^{-t}\cos(2t) - e^{-t}\sin(2t) \\ -e^{-t}\cos(2t)\end{bmatrix} - \begin{bmatrix} e^{-t}\sin(2t) + e^{-t}\cos(2t) \\ -e^{-t}\sin(2t) \end{bmatrix} = \begin{bmatrix} e^{-t}\cos(2t) - 3e^{-t}\sin(2t) \\ -2e^{-t}\cos(2t) + e^{-t}\sin(2t) \end{bmatrix}.
\end{equation*}
\end{exampleSol}
