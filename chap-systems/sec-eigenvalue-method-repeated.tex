...
\LO{
\item Find generalized eigenvectors to write a general solution to a first order system with repeated and defective eigenvalues,
\item Sketch phase portraits for first order linear systems with repeated eigenvalues, and 
