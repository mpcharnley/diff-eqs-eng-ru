...
\task Assume that the chair is built with a dampener with coefficient \unitfrac[16]{Ns}{m}. Set up an initial value problem for this situation if the child acts in the same way as described in (a).
