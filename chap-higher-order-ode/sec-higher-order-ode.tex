...
$y_1$, $y_2$, \ldots, $y_n$ are \index{linearly independent ! functions}\emph{linearly independent} if
the equation
\begin{equation*}
...
are not
linearly independent, they are \index{linearly dependent ! functions}\emph{linearly dependent}.
