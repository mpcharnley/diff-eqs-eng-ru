...
The last component of this process is changing the limits of integration if a definite integral is being computed. The idea is that an integral in $x$ (denoted by $dx$) has its limits also in terms of $x$, but the $du$ integral has endpoints given in terms of $u$. The main way this comes up in problems is that
