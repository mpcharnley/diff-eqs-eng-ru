...
\begin{exercise}
Let $g(x,y)$ be any function so that $g(x,y)$ and $\frac{\partial g}{\partial y}(x,y)$ are continuous for all real numbers $x$ and $y$. Take the differential equation $y' = (y-2x) g(x,y) + 2$.
